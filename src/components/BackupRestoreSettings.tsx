...
export const BackupRestoreSettings: React.FC<BackupRestoreSettingsProps> = ({
  ...
  const handlePushGitHub = async () => {
    const persistentToken = localStorage.getItem('carlamps_github_pat_persistent') || '';
    const tokenToUse = editGhToken.trim() || ghConfig.githubToken?.trim() || persistentToken.trim();
    if (!tokenToUse) {
